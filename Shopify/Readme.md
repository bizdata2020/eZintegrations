# Deployment Steps for Shopify Integration

1. **Download** the Shopify IB files.  
2. **Sign up** or **log in** to the eZintegration environment: [sign up](https://system-na14-west.bizdata360.com/#/start-free-trial?utm_source=github&utm_medium=social&utm_campaign=readme&utm_content=shopify_readme_link) with your **Username** and **Password**.  
